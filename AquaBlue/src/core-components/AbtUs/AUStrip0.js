            ...
            <div className="au-container Story">
                ...
                <div className="au-table LightRed">
                    <div className="au-text">
                        ...
                        <h4 className="au-subtitle">In the Spring of 2020 we were social distancing and connecting virtually, the personal “touch and feel” connection was almost non-existent.  You could easily send someone a gift online but good luck trying to pair that with a personalized thoughtful card.   The idea of 5am Lemon came to me as I wanted to give people the opportunity to create surprise and delight moments through sending fun gifts in a very personalized way.  The first ever 5am Lemon design was a University Graduation Box I did for my daughter Sarah, the excitement and enthusiasm around the box showed me this thing had legs… and the rest is history.</h4>
